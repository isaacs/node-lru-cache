...
function LRUCache (options) {
  ...
  function trim (self) {
    while (lru < self._mru && length > self._max)
      del(self, self._lruList[lru])
  }

  function shiftLU (self, hit) {
    delete self._lruList[ hit.lu ]
    while (lru < self._mru && !self._lruList[lru]) lru ++
  }
